...
function App() {
  ...
  useEffect(()=>{
    ...
    if(winner){
      alert(`Uh-La-La!! ${winner} has won the game!`);
  ...
  return(
    <div className="app-header">
      ...
      <button className="reset" onClick={()=>setGameState(initialState)}>Reset</button>
      <p className="copyright">Copyright © Rajbir Singh 2021</p>
    </div>
  )
}
